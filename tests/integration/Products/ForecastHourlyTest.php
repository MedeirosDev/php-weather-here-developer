...
class ForecastHourlyTest extends TestCase
{
    ...
    public function testForecastHourly(): void
    {
        $response = WeatherHereDeveloper::license($this->license)
            ->setProduct(Product::FORECAST_HOURLY)
    ...
    public function testGeoNode(): void
    {
        ...
        $this->assertTrue($response->successful());
        $this->assertInstanceOf(Forecast7DaysHourlyNode::class, $node);
