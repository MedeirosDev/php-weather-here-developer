...
class Forecast7DaysSimpleTest extends TestCase
{
    ...
    public function testForecast7DaysSimple(): void
    {
        $response = WeatherHereDeveloper::license($this->license)
            ->setProduct(Product::FORECAST_7DAYS_SIMPLE)
    ...
    public function testGeoNode(): void
    {
        ...
        $this->assertTrue($response->successful());
        $this->assertInstanceOf(Forecast7DaysSimpleNode::class, $node);
